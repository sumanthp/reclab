      ...
      <div className="about-hero-band">
        <div className="about-hero">
          <div className="about-hero-copy">
            <span className="about-eyebrow">Open source · Self-hosted</span>
            <h1>Reason about your recommender before you build it</h1>
            <p>
              Choosing a recommendation system architecture is still mostly tribal knowledge.
              reclab profiles your interaction data, reasons about which architecture is likely to
              work and why, and then actually trains and evaluates the candidates on your data so
              you can check that reasoning against real results — instead of just trusting it.
            </p>
          ...
          <div className="about-window">
            <div className="about-window-bar">
              ...
              <span className="about-window-dot" />
              <span className="about-window-dot" />
              <span className="about-window-title">Real shortlist output — Amazon Reviews · Gift_Cards</span>
            </div>
            <div className="about-window-body">
              <div className="rec-card is-first about-preview-card">
                ...
                <p className="rec-rationale">
                  Solid general-purpose baseline for dense collaborative signal
                </p>
              </div>
            </div>
          </div>
